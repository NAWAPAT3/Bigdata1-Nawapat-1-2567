...
export default function Footer() {
  return (
    <div className="shadow-lg p-16 mb-5 bg-body rounded bg-yellow-500">
      <footer className="footer text-base-content p-10">
        <nav className="text-gray font-bold text-XL">
        ...
        <form>
          <h6 className="footer-title text-gray text-XL font-bold">Newsletter</h6>
          <fieldset className="form-control w-80">
            <label className="label">
              <span className="label-text text-gray text-XL font-bold">Enter your email address</span>
            </label>
            <div className="join">
              <input
                type="text"
              ...
              />
              <button className="btn btn-gray join-item ">Subscribe</button>
            </div>
          </fieldset>
        </form>
      </footer>
